 ...
 * •(set) properties of the parent Class • •@author HAUSER •@since 2009-05-12 •
 */
...
public @interface ChildOf {
	 ...
	 * be turned into a Spring bean in case of an autodetected component. * @return
	 * the suggested component name, if any
	 */
	String value() default "";

	/**
	 * * The name of the parent bean - must NOT be null * * @return the parent
	 * beanname
	 */
