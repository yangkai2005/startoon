 ...
 *
 */
public class JSPEntityInputCodeGenerator extends AbstractCodeGenerator
{
	 ...
	 * @param variable
	 */
	public JSPEntityInputCodeGenerator(Map<String, String> variable)
	{
		super(variable);
	}
	...
	protected String getFilePath()
	{
		...
		path += WordDealUtil.wordFormat4JSP(entityName)+"-input.jsp";
		return path;
	...
	{
		return "jsp/JSPEntityInputTemplate.ftl";
	}
