...
<s:form  id="searchForm" action="helpclass-list" namespace="/admin/helpclass">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="helpclass!edit" namespace="/admin/helpclass"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="helpclass!delete" namespace="/admin/helpclass"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="helpclass!input" namespace="/admin/helpclass"/>" title="新建"><span class="btn">新建</span></a>
  </div>
