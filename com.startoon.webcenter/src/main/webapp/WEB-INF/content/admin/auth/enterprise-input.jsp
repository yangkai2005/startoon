...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/auth">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="enterprise-list" namespace="/admin/auth"/>?restore_params=true'">cancel</button></p>
</div>
