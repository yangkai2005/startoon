...
<s:form  id="searchForm" action="p-tags-list" namespace="/admin/ptags">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> <s:if test="pass">显示</s:if><s:else>隐藏</s:else> </td>
    <td> 
    	<a href="<s:url action="p-tags!edit" namespace="/admin/ptags"/>?requestId=<s:property value="id"/>">修改</a>
    	<%--
    	<a href="<s:url action="p-tags!delete" namespace="/admin/ptags"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    	 --%>
    </td>
  </tr>
  </s:iterator>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="p-tags!input" namespace="/admin/ptags"/>" title="新建"><span class="btn">新建</span></a>
  </div>
