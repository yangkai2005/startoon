...
<body>
<div class="mTitle">
  <b class="bbig">帮助中心 - 修改文章</b>
</div>
<form id="form1" action="${pageContext.request.contextPath}/admin/help/help!update.action?ids=${showhelp.id}" method="post">
<!--list -->
<div class="mainAdd">
<table class="addTable">
  ...
  <tr>
    <th>标题:</th> 
	<td> <input type="text" name="title" id="title" value="${showhelp.title}" size="30"/><span id="nameTip"></span> </td>
  </tr>
   <tr>
    <th>详细信息:</th> 
	<td>
