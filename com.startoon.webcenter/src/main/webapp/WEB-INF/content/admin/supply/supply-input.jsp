...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/supply">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="supply-list" namespace="/admin/supply"/>?restore_params=true'">cancel</button></p>
</div>
