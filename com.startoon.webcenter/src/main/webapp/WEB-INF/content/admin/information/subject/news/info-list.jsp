...
<table class="listTable">
  ...
  <tr>  
    ...
    <td>
    	<a href="<s:url action="info!edit" namespace="/admin/information/subject/news"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="info!delete" namespace="/admin/information/subject/news"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="${ctx}/admin/information/subject/news/info!input.action" title="新建"><span class="btn">新建</span></a>
  </div>
