...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/subject/events" enctype="multipart/form-data">
<s:hidden name="nextMethod" />
<s:hidden name="requestId" />
<s:hidden name="id" />
<s:hidden name="contentTxt" />
<s:hidden name="infoType.id"  value="50"/>
<!--list -->
<div class="mainAdd">
	...
	<td>
    	<FCK:editor inputName="content" instanceName="content" height="350">
				<jsp:attribute name="value">
					<s:property value="content" escape="HTML"/>
				</jsp:attribute>
		</FCK:editor>
	</td>
  </tr>
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="info-list" namespace="/admin/information/subject/events"/>?restore_params=true'">返回</button></p>
</div>
