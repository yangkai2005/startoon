...
$(document).ready(function(){
	...
	$("#delBtn").click(function(){
		var cks = $('input[name=ids]:checked');
		$("#auditForm").attr('action', '${ctx}/admin/information/showaudit/info!deleteAll.action');
...
<s:form  id="searchForm" action="info-list" namespace="/admin/information/showaudit">
...
<!--list -->
<div class="mainList">
<s:form  id="auditForm" action="info!audit" namespace="/admin/information/showaudit">
