...
<s:form id="form1" action="advertisement!modify" namespace="/admin/information/advertisement"  enctype="multipart/form-data">
  ...
  <tr>
	...
	<td>
	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="781" height="96">
        <param name="movie" value="<s:property value='validAdImg'/>" />
        <param name="quality" value="high" />
        <embed src="<s:property value='validAdImg'/>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="781" height="96"></embed>
	  </object>	
	</td>
  </tr>
</s:if>
