...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/comments">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="comments-list" namespace="/admin/information/comments"/>?restore_params=true'">cancel</button></p>
</div>
