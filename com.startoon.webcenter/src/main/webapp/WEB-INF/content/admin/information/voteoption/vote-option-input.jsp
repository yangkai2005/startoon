...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/voteoption">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="vote-option-list" namespace="/admin/information/voteoption"/>?restore_params=true'">cancel</button></p>
</div>
