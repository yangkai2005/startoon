...
<body>
<div class="mTitle">
  <b class="bbig">店长吧版区管理</b>
</div>
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/bar">
<s:hidden name="nextMethod" />
<s:hidden name="requestId" />
<s:hidden name="id" />
<s:hidden name="infoType.id" value="5"/>
<s:hidden name="typeLevel" value="2"/>
<!--list -->
<div class="mainAdd">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="info-type-list" namespace="/admin/information/bar"/>?restore_params=true'">返回</button></p>
</div>
