...
<%--
 ...
 --%>
  <b class="bbig">企业招聘信息列表</b>
</div>
<s:form  id="searchForm" action="jobs-list" namespace="/admin/information/job">
...
<s:form  id="auditForm" action="jobs!freeze" namespace="/admin/information/job">
...
<s:hidden id="auditDesc" name="desc"></s:hidden>
  ...
  <tr> 
    ...
    <td> 
    	<a href="${ctx}/information/hrservice/jobs!show.action?requestId=<s:property value="id"/>" target="_blank">详细</a>
    </td>
  </tr>
  </s:iterator>
