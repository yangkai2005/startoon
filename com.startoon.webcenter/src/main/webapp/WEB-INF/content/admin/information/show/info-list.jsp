...
<s:form  id="searchForm" action="info-list" namespace="/admin/information/show">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="info!edit" namespace="/admin/information/show"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="info!delete" namespace="/admin/information/show"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="info!input" namespace="/admin/information/show"/>" title="新建"><span class="btn">新建</span></a>
  </div>
