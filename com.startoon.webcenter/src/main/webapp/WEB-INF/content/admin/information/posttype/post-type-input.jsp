...
$(document).ready(function(){
 	...
 	$("#name").formValidator({onshow:"",onfocus:"版权名称不能为空！",oncorrect:""}).inputValidator({min:1,max:100,onerror:"版权名称不能为空！"});
});
</script>
...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/posttype">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="post-type-list" namespace="/admin/information/posttype"/>?restore_params=true'">返回</button></p>
</div>
