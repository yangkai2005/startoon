...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/voteoptiondetail">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="vote-option-detail-list" namespace="/admin/information/voteoptiondetail"/>?restore_params=true'">cancel</button></p>
</div>
