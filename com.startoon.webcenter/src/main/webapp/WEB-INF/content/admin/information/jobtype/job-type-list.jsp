...
<s:form  id="searchForm" action="job-type-list" namespace="/admin/information/jobtype">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="job-type!edit" namespace="/admin/information/jobtype"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="job-type!delete" namespace="/admin/information/jobtype"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="job-type!input" namespace="/admin/information/jobtype"/>" title="新建"><span class="btn">新建</span></a>
  </div>
