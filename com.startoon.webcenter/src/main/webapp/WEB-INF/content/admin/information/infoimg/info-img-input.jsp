...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/infoimg">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="info-img-list" namespace="/admin/information/infoimg"/>?restore_params=true'">cancel</button></p>
</div>
