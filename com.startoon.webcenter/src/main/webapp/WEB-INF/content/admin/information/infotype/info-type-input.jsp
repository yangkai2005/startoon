...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/infotype">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="info-type-list" namespace="/admin/information/infotype"/>?restore_params=true'">cancel</button></p>
</div>
