...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/attachments">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="attachments-list" namespace="/admin/information/attachments"/>?restore_params=true'">cancel</button></p>
</div>
