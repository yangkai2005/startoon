...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/information/subject/video" enctype="multipart/form-data">
<s:hidden name="nextMethod" />
<s:hidden name="requestId" />
<s:hidden name="id" />
<s:hidden name="contentTxt" />
<s:hidden name="infoType.id" value="51" />
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="info-list" namespace="/admin/information/subject/video"/>?restore_params=true'">返回</button></p>
</div>
