...
<table class="listTable">
  ...
  <tr>  
    ...
    <td>
    	<a href="<s:url action="info!edit" namespace="/admin/information/info"/>?requestId=<s:property value="id"/>&tid=<s:property value="pager.paramCondition['tid']"/>">修改</a>  
    	<a href="<s:url action="info!delete" namespace="/admin/information/info"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="${ctx}/admin/information/info/info!input.action?tid=<s:property value='tid'/>" title="新建"><span class="btn">新建</span></a>
  </div>
