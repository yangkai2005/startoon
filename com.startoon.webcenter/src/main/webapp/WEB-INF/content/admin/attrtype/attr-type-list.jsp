...
<div class="mTitle">
  ...
  <b class="bbig">属性分类名称列表</b>
</div>
<s:form  id="searchForm" action="attr-type-list" namespace="/admin/attrtype">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="attr-type!edit" namespace="/admin/attrtype"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="attr-type!delete" namespace="/admin/attrtype"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="attr-type!input" namespace="/admin/attrtype"/>" title="新建"><span class="btn">新建</span></a>
  </div>
