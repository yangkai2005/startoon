...
<s:form  id="searchForm" action="mail-queue-list" namespace="/admin/mailqueue">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="mail-queue!edit" namespace="/admin/mailqueue"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="mail-queue!delete" namespace="/admin/mailqueue"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="mail-queue!input" namespace="/admin/mailqueue"/>" title="新建"><span class="btn">新建</span></a>
  </div>
