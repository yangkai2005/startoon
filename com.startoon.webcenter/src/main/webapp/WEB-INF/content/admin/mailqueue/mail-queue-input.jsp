...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/mailqueue">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="mail-queue-list" namespace="/admin/mailqueue"/>?restore_params=true'">cancel</button></p>
</div>
