...
$(document).ready(function(){
 	...
 	$("#name").formValidator({onshow:"",onfocus:"行业名称不能为空",oncorrect:""}).inputValidator({min:1,max:100,onerror:"行业名称不能为空"});
});
</script>
...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/industry">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="industry-list" namespace="/admin/industry"/>?restore_params=true'">取消</button></p>
</div>
