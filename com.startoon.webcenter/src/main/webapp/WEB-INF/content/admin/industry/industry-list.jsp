...
<!--<s:form  id="searchForm" action="industry-list" namespace="/admin/Industry">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="industry!edit" namespace="/admin/industry"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="industry!delete" namespace="/admin/industry"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="industry!input" namespace="/admin/industry"/>" title="新建"><span class="btn">新建</span></a>
  </div>
