...
<s:form  id="searchForm" action="news-type-list" namespace="/admin/newstype">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="news-type!edit" namespace="/admin/newstype"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="news-type!delete" namespace="/admin/newstype"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="news-type!input" namespace="/admin/newstype"/>" title="新建"><span class="btn">新建</span></a>
  </div>
