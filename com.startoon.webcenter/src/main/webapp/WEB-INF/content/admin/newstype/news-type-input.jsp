...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/newstype">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="news-type-list" namespace="/admin/newstype"/>?restore_params=true'">cancel</button></p>
</div>
