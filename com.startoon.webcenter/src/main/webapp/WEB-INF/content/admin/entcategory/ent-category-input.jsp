...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/entcategory">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="ent-category-list" namespace="/admin/entcategory"/>?restore_params=true'">cancel</button></p>
</div>
