...
<body>
<div class="mTitle">
  <b class="bbig">网站内容管理</b>
</div>
<s:form  id="searchForm" action="news-list" namespace="/admin/news">
...
<table class="listTable">
  ...
  <tr>
    ...
    <td> 
    	<a href="<s:url action="news!edit" namespace="/admin/news"/>?requestId=<s:property value="id"/>">修改</a>  
    	<%--<a href="<s:url action="news!delete" namespace="/admin/news"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a> --%>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<!--<a href="<s:url action="news!input" namespace="/admin/news"/>" title="新建"><span class="btn">新建</span></a>
  --></div>
