...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/news">
...
<table class="addTable">
  <tr>
    <th>标题名称:</th> 
	<td> <b class="bbig"><s:property value="title"/></b> </td>
  </tr>
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="news-list" namespace="/admin/news"/>?restore_params=true'">返回</button></p>
</div>
