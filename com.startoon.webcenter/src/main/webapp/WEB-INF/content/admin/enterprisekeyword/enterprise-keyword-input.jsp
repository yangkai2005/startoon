...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/enterprisekeyword">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="enterprise-keyword-list" namespace="/admin/enterprisekeyword"/>?restore_params=true'">cancel</button></p>
</div>
