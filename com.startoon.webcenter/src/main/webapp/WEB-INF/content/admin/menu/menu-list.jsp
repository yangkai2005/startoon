...
<s:form  id="searchForm" action="menu-list" namespace="/admin/menu">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="menu!edit" namespace="/admin/menu"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="menu!delete" namespace="/admin/menu"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="menu!input" namespace="/admin/menu"/>" title="新建"><span class="btn">新建</span></a>
  </div>
