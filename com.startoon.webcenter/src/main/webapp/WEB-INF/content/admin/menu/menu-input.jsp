...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/menu">
...
<table class="addTable">
  <tr>
    <th>父目录:</th> 
	<td> <s:select list="%{menus}" name="fatherId" id="fatherId" listKey="id" listValue="name" headerKey="" headerValue="--请选择--"></s:select><span id="fatherIdTip"></span> </td>
  </tr>
  <tr>
    <th>名称:</th> 
  ...
  <tr>
    <th>是否可用:</th> 
	<td> <s:radio list="#{true:'可用', false:'不可以'}" id="enabled" name="enabled"></s:radio> <span id="enabledTip"></span> </td>
  </tr>
</table>
</div>
<!--end list -->
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="menu-list" namespace="/admin/menu"/>?restore_params=true'">cancel</button></p>
</div>
