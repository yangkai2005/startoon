...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/clickedkeyword">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="clicked-keyword-list" namespace="/admin/clickedkeyword"/>?restore_params=true'">cancel</button></p>
</div>
