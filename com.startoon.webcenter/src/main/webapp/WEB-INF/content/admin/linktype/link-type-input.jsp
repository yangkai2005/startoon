...
$(document).ready(function(){
 	...
 	$("#name").formValidator({onshow:"",onfocus:"友情链接类别名称不能为空",oncorrect:""}).inputValidator({min:1,max:100,onerror:"友情链接类别名称不能为空"});
});
</script>
...
<body>
<div class="mTitle">
  <b class="bbig">友情链接类别</b>
</div>
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/admin/linktype">
...
<table class="addTable">
  ...
  <tr>
    <th>友情链接类别描述:</th> 
	<td> <s:textarea name="description" id="description"></s:textarea><span id="nameTip"></span> </td>
  </tr>
</table>
</div>
<!--end list -->
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="link-type-list" namespace="/admin/linktype"/>?restore_params=true'">返回</button></p>
</div>
