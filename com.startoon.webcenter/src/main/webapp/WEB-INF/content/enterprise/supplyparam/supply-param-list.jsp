...
<s:form  id="searchForm" action="supply-param-list" namespace="/enterprise/supplyparam">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="supply-param!edit" namespace="/enterprise/supplyparam"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="supply-param!delete" namespace="/enterprise/supplyparam"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="supply-param!input" namespace="/enterprise/supplyparam"/>" title="新建"><span class="btn">新建</span></a>
  </div>
