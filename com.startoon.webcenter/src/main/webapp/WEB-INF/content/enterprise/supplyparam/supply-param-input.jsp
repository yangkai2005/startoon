...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/supplyparam">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="supply-param-list" namespace="/enterprise/supplyparam"/>?restore_params=true'">cancel</button></p>
</div>
