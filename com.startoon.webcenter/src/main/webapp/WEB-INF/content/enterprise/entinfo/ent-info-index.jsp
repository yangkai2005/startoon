...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<form id="form1" name="form1" action="${ctx}/enterprise/entinfo/ent-info!modifyIndex.action" enctype="multipart/form-data" method="post">
	<div class="memcon">
		<div class="memqy">
		<s:include value="/WEB-INF/content/enterprise/entinfo/menu.jsp" />
		<h2>
		<p align="center">
    	<FCK:editor instanceName="indexContent" height="350" toolbarSet="B2B">
			<jsp:attribute name="value"><s:property value="entInfo.indexContent" escape="html" /></jsp:attribute>
		</FCK:editor>
		</p>
		...
		<p align="left">
			公司LOGO图片：<input style="width:300px;" type="file" name="logo"/>  图片的尺寸为：181×131<br />
		</p>
		<br/>
		<p align="center">
