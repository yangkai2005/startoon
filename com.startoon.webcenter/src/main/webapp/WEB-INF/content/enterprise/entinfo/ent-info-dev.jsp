...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<form id="form1" name="form1" action="${ctx}/enterprise/entinfo/ent-info!modifyDev.action" method="post">
	<div class="memcon">
		<div class="memqy">
		<s:include value="/WEB-INF/content/enterprise/entinfo/menu.jsp" />
		<h2>
		<p align="center">
			<FCK:editor instanceName="developContent" height="350" toolbarSet="B2B">
				<jsp:attribute name="value">
					<s:property value="developContent" escape="html" />
				</jsp:attribute>
			</FCK:editor>					
		</p>
