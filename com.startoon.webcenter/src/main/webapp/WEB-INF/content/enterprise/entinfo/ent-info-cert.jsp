...
<script type="text/javascript" src="${ctx}/resources/My97DatePicker/calendar.js"></script>
...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<div class="memcon">
		...
		<form id="form1" name="form1" method="post" action="${ctx}/enterprise/entinfo/ent-info-cert!insert.action" enctype="multipart/form-data">
		...
		<br/>		
		<p align="left">生效日期：<input type="text" name="cert.activeTime" id="adate" style="width: 100px;" value ="<s:date name="cert.activeTime" format="yyyy-MM-dd"/>" onfocus="Wdatepicker()" class="Wdate" /></p>
		<br/>		
		<p align="left">到期日期：<input type="text" name="cert.finishTime" id="fdate" style="width: 100px;" value ="<s:date name="cert.finishTime" format="yyyy-MM-dd"/>"/></p>
		<br/>
		<p align="left">
		...
		<p align="center">
			...
			<FCK:editor instanceName="description" height="380">
		...
		<p align="center">
			...
			<input name="Input4" type="button"  value="取消"  class="btn01" onclick="javascript:history.back();"/>
		</p>
		</h2>
		</form>
