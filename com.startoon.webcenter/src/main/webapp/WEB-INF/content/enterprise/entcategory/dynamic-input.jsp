...
<div class="memright">
	...
	<div class="memcon">
		...
		<form id="form1" name="form1" action="${ctx}/enterprise/dynamic/dynamic!insert.action" method="post">
		<h2>
		<p align="left">动态标题：<input type="text" name="dynamic.title" id="title" style="width: 350px;"/></p>
		<br/>
		<p align="center">
