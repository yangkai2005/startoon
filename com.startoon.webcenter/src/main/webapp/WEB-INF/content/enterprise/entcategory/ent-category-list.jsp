...
$(function() {
	...
	$("#addBtn").click(function() {
		window.location.href = "<s:url namespace="/enterprise/entcategory" action="ent-category!input"/>";
	});
...
<div class="memright">
	...
	<div class="memcon">
		...
		<s:form id="delForm" name="delForm" namespace="/enterprise/entcategory" action="ent-category!deleteAll">
		  <s:iterator value="pager.items">
			  <tr>
			  	<td><input name="ids" type="checkbox" value='<s:property value="id" />'/></td>
			    <td><s:property value="category.name" /></td>
			    <td>
		   			<a href="${pageContext.request.contextPath }/enterprise/entcategory/ent-category!delete.action?requestId=${id}">删除</a>
			    </td>
			  </tr>
		  </s:iterator>
		 </s:form>
		</table>
		<div><input type="button" id="deleteAllBtn" name="submitBtn" value="删除" class="mbtn2"/><input type="button" id="addBtn" name="addBtn" value="新增" class="mbtn2"/></div>
		<div align="right"><e:pagination/></div>
		</div>
