...
<s:form  id="searchForm" action="recommend-supply-list" namespace="/enterprise/recommendsupply">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="recommend-supply!edit" namespace="/enterprise/recommendsupply"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="recommend-supply!delete" namespace="/enterprise/recommendsupply"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="recommend-supply!input" namespace="/enterprise/recommendsupply"/>" title="新建"><span class="btn">新建</span></a>
  </div>
