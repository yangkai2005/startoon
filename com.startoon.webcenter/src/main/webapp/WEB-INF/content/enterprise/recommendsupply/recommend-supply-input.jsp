...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/recommendsupply">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="recommend-supply-list" namespace="/enterprise/recommendsupply"/>?restore_params=true'">cancel</button></p>
</div>
