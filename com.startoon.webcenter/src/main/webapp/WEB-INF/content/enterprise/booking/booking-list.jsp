...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<div class="memcon">
		...
		<div class="subscribe">
		<s:form id="form1" namespace="/enterprise/booking" action="booking!insert">
  ...
  <tr>
    ...
    <td><a href="<s:url namespace="/enterprise/booking" action="booking!delete"/>?requestId=${id}">删除</a></td>
  </tr>
  </s:iterator>
</tbody></table>
</div>
