...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<div class="memcon">
		...
		<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/message">
		<s:hidden name="nextMethod" />
		<s:hidden name="requestId" />
		<s:hidden name="id" />
		<s:hidden name="contentTxt" id="contentTxt" />
		<h2>
		<p align="left">收&nbsp;信&nbsp;人：<s:select name="receiverId" id="receiverId"  list="%{enterprises}" listKey="id" listValue="name" cssStyle="width: 350px;"></s:select> </p>
		<br/>
		<p align="left">信息标题：<s:textfield name="title" id="title" cssStyle="width: 350px;"></s:textfield></p>
		<br/>
		<p align="left">信息内容：</p>
		<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textarea id="content" name="content" cols="45" rows="10"></s:textarea></p>
