...
$(document).ready(function(){
	...
	$('#btnSubmit').click(function() {
 	...
 	$("#form1").submit(function(){
 	 	...
 	 	$(':hidden[name=contentText]').val(txt);
 	 });	
});
</script>
</head>
...
<div class="memright">
	...
	<div class="memcon">
		...
		<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/dynamic">
		<s:hidden name="nextMethod" />
		<s:hidden name="requestId" />
		<s:hidden name="id" />		
		<s:hidden name="contentText" />		
		
		<h2>
		<p align="left">动态标题： <s:textfield name="title" cssStyle="width: 350px;"/></p>
		<br/>
		<p align="center">
