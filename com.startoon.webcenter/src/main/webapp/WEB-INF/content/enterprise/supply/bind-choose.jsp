...
$(document).ready(function(){
	$(':radio[name=keywordType]').click(function() {
		var t = $(this).val();
		if(t==1) {
			var url = '${ctx}/enterprise/enterprisecategorykeyword/enterprise-category-keyword-list.action?flag=1&supplyId=<%=request.getParameter("supplyId") %>';
			window.location = url;
		} else {
			var url = '${ctx}/enterprise/supply/enterprise-keyword-list.action?&supplyId=<%=request.getParameter("supplyId") %>';
			window.location = url;
		}
	});
});
