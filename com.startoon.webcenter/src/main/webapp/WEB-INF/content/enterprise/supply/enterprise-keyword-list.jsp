...
<div class="windowSize510" style="height: 280px;">
  ...
  <s:form id="bindForm" name="bindForm" namespace="/enterprise/supply" action="bind">
  ...
  <tr>
    ...
    <td> <s:property value="keyword.keyword"/> </td>
    <td> <s:property value="price"/>元 </td>
    <td> <s:date name="ctime" format="yyyy-MM-dd"/> </td>
    <td> <s:date name="keyword.deadTime" format="yyyy-MM-dd"/> </td>
  </tr>
  </s:iterator>
  </table>
  </s:form>
