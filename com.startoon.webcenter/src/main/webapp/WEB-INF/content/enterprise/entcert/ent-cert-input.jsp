...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/entcert">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="ent-cert-list" namespace="/enterprise/entcert"/>?restore_params=true'">cancel</button></p>
</div>
