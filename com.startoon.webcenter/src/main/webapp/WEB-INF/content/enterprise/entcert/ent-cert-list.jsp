...
<s:form  id="searchForm" action="ent-cert-list" namespace="/enterprise/entcert">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="ent-cert!edit" namespace="/enterprise/entcert"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="ent-cert!delete" namespace="/enterprise/entcert"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="ent-cert!input" namespace="/enterprise/entcert"/>" title="新建"><span class="btn">新建</span></a>
  </div>
