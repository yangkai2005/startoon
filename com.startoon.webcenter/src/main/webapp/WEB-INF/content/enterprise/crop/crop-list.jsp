...
<s:form  id="searchForm" action="crop-list" namespace="/enterprise/crop">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="crop!edit" namespace="/enterprise/crop"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="crop!delete" namespace="/enterprise/crop"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="crop!input" namespace="/enterprise/crop"/>" title="新建"><span class="btn">新建</span></a>
  </div>
