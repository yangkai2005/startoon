...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/supplyproperty">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="supply-property-list" namespace="/enterprise/supplyproperty"/>?restore_params=true'">cancel</button></p>
</div>
