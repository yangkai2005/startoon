...
<div class="memright">
	...
	<table width="100%" border="0" cellspacing="0" bgcolor="#d7e2ec" class="sitable">
	  <tbody><tr>
	    <th width="16%" class="noleft">充值订单编号</th>
	    <th width="36%">充值时间</th>
	    <th width="">充值人</th>
	    <th width="17%">充值金额</th>
	  </tr>
	  ...
	  <tr>
	    <td class="noleft tdlist"> <s:property value="orderid"/> </td>
	    <td class="tdlist"><s:date name="ordertime" format="yyyy-MM-dd HH:mm"/></td>
	    <td>
	    	<s:if test="type==1">后台管理员</s:if>
	    	<s:else><s:property value="creator.nickname"/></s:else>
	    </td>
	    <td><s:property value="amount"/>元</td>
	  </tr>
	  </s:iterator>
	</tbody>
	</table>
