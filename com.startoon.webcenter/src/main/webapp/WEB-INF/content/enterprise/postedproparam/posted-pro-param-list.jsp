...
<s:form  id="searchForm" action="posted-pro-param-list" namespace="/enterprise/postedproparam">
...
<table class="listTable">
  ...
  <tr>  
	...
	<td> col2 </td>
    <td> 
    	<a href="<s:url action="posted-pro-param!edit" namespace="/enterprise/postedproparam"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="posted-pro-param!delete" namespace="/enterprise/postedproparam"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="posted-pro-param!input" namespace="/enterprise/postedproparam"/>" title="新建"><span class="btn">新建</span></a>
  </div>
