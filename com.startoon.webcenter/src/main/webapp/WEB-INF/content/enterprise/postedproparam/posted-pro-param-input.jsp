...
<s:form id="form1" action="%{actionName+'!'+nextMethod}" namespace="/enterprise/postedproparam">
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="posted-pro-param-list" namespace="/enterprise/postedproparam"/>?restore_params=true'">cancel</button></p>
</div>
