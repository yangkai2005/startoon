...
$(document).ready(function(){
	...
	$("#addBtn").click(function() {
		window.location.href = "${ctx}/enterprise/cert/cert!input.action";
	});
...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<div class="memcon">
		...
		<s:form id="delForm" name="delForm" namespace="/enterprise/cert" action="cert!deleteAll">
		  <s:iterator value="pager.items">
			  <tr>
			  	<td><input name="ids" type="checkbox" value='<s:property value="id" />'/></td>
		   		<td align="center"><s:property value="name"/></td>
		   		<td align="center"><s:property value="certNo"/></td>
		   		<td align="center"><s:property value="type"/></td>
		   		<td align="center"><s:date name="activeTime" format="yyyy-MM-dd" /></td>
		   		<td align="center"><s:date name="finishTime" format="yyyy-MM-dd" /></td>
		   		<td align="center"><s:property value="certOrg"/></td>
			    <td>
		   			<a href="${pageContext.request.contextPath }/enterprise/cert/cert!input.action?requestId=${id}">修改</a>
			    </td>
			  </tr>
		  </s:iterator>
		 </s:form>
