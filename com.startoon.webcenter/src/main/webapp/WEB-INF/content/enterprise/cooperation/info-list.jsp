...
$(document).ready(function(){
	...
	$("#addBtn").click(function() {
		window.location.href = "<s:url namespace="/enterprise/cooperation" action="info!input"/>";
	});
...
<div class="title4"> <div class="hotline">客服热线：020-39106666</div>
	...
	<div class="memcon">
		...
		<s:form id="delForm" name="delForm" namespace="/enterprise/cooperation" action="info!deleteAll">
		  <s:iterator value="pager.items">
			  <tr>
			    ...
			    <td>
		   			<!--<a href="${pageContext.request.contextPath }/enterprise/cooperation/info!show.action?requestId=${id}" target="_blank">预览</a> -->
		   			<a href="${pageContext.request.contextPath }/enterprise/cooperation/info!edit.action?requestId=${id}">修改</a>
			    </td>
			  </tr>
		  </s:iterator>
		 </s:form>
