...
<script language="javascript1.1" type="text/javascript" src="js/jquery-1.4.2.js"></script>
...
<div class="top">
<div id="wrap">
<div class="topleft"><a href="index.html">网站首页</a> <span class="f8">┆</span>  <a href="index.html">采购平台</a>  <span class="f8">┆</span>  <a href="index.html">资讯频道</a>  <span class="f8">┆</span>  <a href="index.html">企业推广</a> </div>

<div class="topright"><a href="member/reg.html" class="color1">免费注册</a>  <span class="f8">┆</span>  <a href="member/login.html">登录</a>  <span class="f8">┆</span>  <a href="member/index.html" class="color1">会员中心</a> <span class="f8">┆</span>  <a href="#">帮助中心</a>  <span class="f8">┆</span>  <a href="#" class="color1">设为首页</a></div>
