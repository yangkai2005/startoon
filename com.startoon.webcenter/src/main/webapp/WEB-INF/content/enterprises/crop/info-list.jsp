...
<div class="right">
 ...
 <div class="mconter3">
  ...
  <li><div class="time"><s:date name="createTime" format="yyyy-MM-dd"/></div><a href="${ctx}/enterprises/crop/info!show.action?requestId=<s:property value='id'/>"><s:property value="title"/></a></li>
  </s:iterator>
  </ul>
