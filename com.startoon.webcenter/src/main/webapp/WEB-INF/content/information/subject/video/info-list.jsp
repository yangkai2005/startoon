...
<div class="main">
	<div class="left blueBorder">
		...
		<ul class="cartoonList">
			...
			<li>
				<a target="_blank" href="${ctx}/information/video/info!show.action?requestId=${id }"><img src="<s:property value="mainImg.smallImg"/>" width="120" height="90"/></a>
				<p><a target="_blank" href="${ctx}/information/video/info!show.action?requestId=${id }"><s:property value="getTitleByLength(8)"/></a></p>
			</li>
			</s:iterator>
		</ul>
		<div class="cls"></div>
