			...
			<s:iterator value="pager.items">
				<li>
					...
					<div class="txtImgNews">
						<p class="titleTxtImg"><span class="fr"><s:date name="createTime" format="yyyy-MM-dd"/></span><a href="${ctx}/information/info/info!show.action?requestId=${id}" target="_blank"><s:property value="title"/></a></p>
