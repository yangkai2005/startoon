...
<div class="left blueBorder">
		...
		<ul class="imgNewsList">
			<s:iterator value="pager.items">
				<li>
					<a href="${ctx}/information/events/info!show.action?requestId=${id}" target="_blank"><img src="<s:property value='mainImg.smallImg'/>" width="100" height="75"/></a>
					<div class="txtImgNews">
						<p class="titleTxtImg"><span class="fr"><s:date name="infoTime" format="yyyy-MM-dd"/></span><a href="${ctx}/information/events/info!show.action?requestId=${id}" target="_blank"><s:property value="title"/></a></p>
						<p class="t2m"><s:property value="contentTxt125"/><a href="${ctx}/information/events/info!show.action?requestId=${id}" target="_blank">&gt;&gt;&gt;详细</a></p>
					</div>
				</li>
			</s:iterator>
		</ul>
