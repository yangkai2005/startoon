	...
	<div class="newsBox">
		...
		<div class="newsBoxCont">
			<ul class="policyList">
				...
				<li><span class="fr"> <s:date name="infoTime" format="yyyy-MM-dd"/> </span><a href="${ctx}/information/info/info!show.action?requestId=${id}" target = "_blank"><s:property value="title"/></a></li>
				</s:iterator>
			</ul>
			<div class="cls"></div>
