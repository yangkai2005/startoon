...
<div class="main">
	...
	<div class="newsBox">
		<div class="titleNews"><span><s:property value="infoType.name"/></span></div>
		<div class="newsBoxCont">
			<ul class="policyList">
				<s:iterator value="pager.items">
				<li><span class="fr"> <s:date name="infoTime" format="yyyy-MM-dd"/> </span><a href="${ctx}/information/survey/info!show.action?requestId=${id}" target="_blank"><s:property value="title"/></a></li>
				</s:iterator>
			</ul>
			<div class="cls"></div>
