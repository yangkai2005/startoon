...
<div class="main">
	...
	<e:adquery id="ad1" adId="210"/>
	<div class="banob"><a id="210" rel="ad" target="_blank" href="<e:adlink name="ad1"/>"><img src="<e:adimg name="ad1"/>" width="970" height="84" /></a></div>
	
	<div class="intleft">
		<div class="inttwo">
			<h1><div class="int1">星力观察家</div></h1>
			<h2>
			<ul class="intlist1">
	...
	<div class="intright">
		<div class="intrgone">
		<div class="inttitle"><div class="more11"><a href="${ctx}/information/info/info-list-img.action?infoTypeId=6" target="_blank">更多&gt;&gt;</a></div><div class="int1">往期关注</div></div>
		...
		<e:adquery id="ad2" adId="211"/>
		<div class="banint1" style="margin-bottom:0"><a id="211" rel="ad" target="_blank" href="<e:adlink name="ad2"/>"><img src="<e:adimg name="ad2"/>" width="288" height="130" /></a></div>	
	</div>
