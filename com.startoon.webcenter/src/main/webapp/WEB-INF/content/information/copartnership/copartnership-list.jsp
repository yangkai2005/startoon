...
<div class="linkstitle"><span style="display:none;"><img src="${ctx}/information/images/linkt1.jpg" width="74" height="27" /></span></div>

<ul class="linkslist3" >
<s:iterator value="pager.items">
<li><a href="<s:property value='siteUrl'/>" target="_blank"><img src="<s:property value='normalLogo'/>" width="146" height="56" alt="<s:property value='name'/>" /></a><a href="<s:property value='siteUrl'/>" target="_blank"><s:property value='name'/></a></li>
</s:iterator>
</ul>
