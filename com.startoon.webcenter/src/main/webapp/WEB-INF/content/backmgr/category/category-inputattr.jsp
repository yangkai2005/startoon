...
<body>
<div class="mTitle">
  <b class="bbig">添加产品类别属性</b>
</div>
<form id="form1" name="frmInput" onsubmit="return doSubmit();" action="${pageContext.request.contextPath }/backmgr/category/category!insertattr.action" method="post">
<!--list -->
<div class="mainAdd">
  ...
  <tr>
   ...
   --><tr>
    ...
    <td class="pktdr2">
    <input name="attrname" id="attrname" maxlength="30" type="text" class="input6"/>
   </td>
  </tr>
    <tr>
    <td valign="top" class="pktdl2">属性值：</td>
    <td class="pktdr2">
    <textarea name="attrvalue" rows="5" cols="50" id="attrvalue" class="input6"></textarea>
