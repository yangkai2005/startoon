...
<form name="frmInput" onsubmit="return doSubmit();" action="${pageContext.request.contextPath }/backmgr/category/category!update.action" method="post">
<!--list -->
<div class="mainAdd">
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="pktdr2">
    <input name="cname" id="cname" maxlength="30" type="text" value="${cname}" class="input6"/>
   </td>
  </tr>
    <tr>
    <td valign="top" class="pktdl2">说明：</td>
    <td class="pktdr2">
    <textarea name="remark" rows="5" cols="50" id="remark" class="input6">${remark}</textarea>
   </td>
  </tr>
  <tr>
    <td class="pktdl2">&nbsp;</td>
