...
<script language="JavaScript" src="${pageContext.request.contextPath }/resources/js/tool.js" type="text/javascript"></script>

<script type="text/javascript"> 
$(document).ready(function(){
	<s:if test='message=="success"'>
	alert('您的提问已经成功提交，感谢您的参与!');
	</s:if>
