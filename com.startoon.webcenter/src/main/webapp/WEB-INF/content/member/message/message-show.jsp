...
$(function() {
	$("h2#messageType<s:property value='messageType'/>").addClass("q3");
});
</script>
...
<div class="memright">
	...
	<div class="memcon">
			...
			<div class="chongzhi1" style="text-align: center;"> <s:label name="title"></s:label> </div>
			<div class="chongzhi3"><s:property value="content"/> </div>
		</div>
