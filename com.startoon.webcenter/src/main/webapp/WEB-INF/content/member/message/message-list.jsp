...
<div class="memright">
	<div class="title4">
		...
		<s:include value="/WEB-INF/content/inc/person-msg-menu.jsp"/>
	</div>
	...
	<table width="100%" border="0" cellspacing="1" class="xinxitable" bgcolor="#ebebeb">
	  ...
	  <tr>
	    ...
	    <td class="tdright"><a href="${ctx}/member/message/message!show.action?requestId=<s:property value='id'/>"> <s:property value="title"/> </a></td>
	    <td><a href="${ctx}/member/message/message!delete.action?requestId=<s:property value='id'/>">删除</a></td>
	  </tr>
	  </s:iterator>
	</tbody>
	</table>
