		...
		<s:form id="delForm" name="delForm" namespace="/member/favorite" action="favorite!deleteAll">
		  <s:iterator value="pager.items">
			  <tr>
			    ...
			    <td><s:property value="postedPro.proName" />&nbsp;</td>
			    <td><s:property value="postedPro.proPrice" />&nbsp;</td>
			    <td><s:date name="postedPro.createTime" format="yyyy-MM-dd"/>&nbsp;</td>
			    <td><s:date name="createTime" format="yyyy-MM-dd"/>&nbsp;</td>
			    <td>
		   			<a href="${pageContext.request.contextPath }/postedpro/posted-pro!detail.action?requestId=${postedPro.id}" target="_blank">详细</a>
			    </td>
			  </tr>
		  </s:iterator>
		 </s:form>
