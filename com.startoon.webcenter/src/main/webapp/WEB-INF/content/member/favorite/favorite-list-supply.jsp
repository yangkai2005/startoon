...
<%-- 列表管理 --%>
<div class="memright">
	<s:include value="/WEB-INF/content/member/favorite/menu.jsp"/>
	...
	<div class="memcon2">
		...
		<s:form id="delForm" name="delForm" namespace="/member/favorite" action="favorite!deleteAll">
		  <s:iterator value="pager.items">
			  <tr>
			  	<td style=" border-left:0; text-align:left; padding-left:5px;"><input name="ids" type="checkbox" value='<s:property value="id" />' /></td>
			    <td><img src="${ctx}/FileView?id=${supply.productImgUrl}" width="47" height="47" /></td>
			    <td style="font-weight:bold"><s:property value="supply.name" />&nbsp;</td>
			    <td><s:property value="supply.proPrice" />&nbsp;</td>
			    <td><s:property value="supply.creator.name" />&nbsp;</td>
			    <td><s:date name="createTime" format="yyyy-MM-dd"/>&nbsp;</td>
			    <td>
		   			<a href="${pageContext.request.contextPath }/supply/supply-manage!detail.action?supplyId=${supply.id}" target="_blank">详细</a>
			    </td>
			  </tr>
		  </s:iterator>
		 </s:form>
