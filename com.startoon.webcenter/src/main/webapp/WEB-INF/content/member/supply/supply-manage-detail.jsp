...
<p>
产品价格：<span class="red"><s:property value="supply.price" /></span>   <span class="red">1<s:property value="supply.unit" /></span> <br />
...
主营行业: <s:property value="supply.creator.linkman" /> <br />
所在地：<s:property value="supply.creator.linkman" /><br />
...
<span class="f14 b">产品名称： <s:property value="supply.name" /></span><br />
<s:property value="supply.description" escape="HTML" /><div class="play" id="con_pro_2"></div>
