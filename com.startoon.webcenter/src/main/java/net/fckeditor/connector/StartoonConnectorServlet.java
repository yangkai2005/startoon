 ...
 * cycle, forwards requests to the {@link MyDispatcher dispatcher} and ends the
 ...
 */
public class StartoonConnectorServlet extends HttpServlet {
	private static final long serialVersionUID = -5742008970929377161L;
	private final Logger logger = LoggerFactory.getLogger(StartoonConnectorServlet.class);
	private transient MyDispatcher dispatcher;
	...
	public void init() throws ServletException {
		try {
			dispatcher = new MyDispatcher(getServletContext());
		} catch (Exception e) {
