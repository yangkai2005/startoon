...
public class ScaleImage {
	...
	public static void main(String[] args) {
		...
		try {
			is.saveImageAsJpg("d:/img/line0053.jpg", "d:/2011/03/14/1.jpg", 350, 100);
	 ...
	 * 
	 * @param source 原图片地址
	 * @param target  生成缩略图地址
	 * @param formatWideth  生成图片宽度
	 * @param formatHeight  生成图片高度
	 */
	public void saveImageAsJpg(String source, String target, int formatWideth, int formatHeight) throws Exception {

		File sourceFile = new File(source);
		File targetFile = new File(target);

		saveImageAsJpg(sourceFile, targetFile, formatWideth, formatHeight);
	 ...
	 * @throws Exception
	 */
	public void saveImageAsJpg(File sourceFile, File targetFile, int formatWideth, int formatHeight) throws Exception {

		BufferedImage srcImage;
		File saveFile = targetFile;
		File fromFile = sourceFile;

		String target = targetFile.getPath();
		String targetPath = target.replace("\\", "/");
