...
public class UploadServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 1620333041553471716L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//文件保存目录路径
		String savePath = SystemConfig.UPLOAD_FILE_DIR + "/";

		//文件保存目录URL
		String saveUrl = request.getContextPath() + "/FileView?id=";
		...
		if (items == null) {
			response.getWriter().println(getError("上传文件异常。"));
			return;
		}
