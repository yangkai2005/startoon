...
public class InfoListAction extends ServiceBasePaginationAction<Info, Long> {
	...
	public void preExecute() {
		...
		// 专题
		if (infoType.getTypeNo().startsWith("0012")) {
			typeIdEq2 = true;
			InfoType subject = infoTypeService.getEntityById(17L);
			String infoTypeName = infoType.getName();
			subject.setName(infoTypeName);
			infoType = subject;
		}
