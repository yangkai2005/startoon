...
@Repository
public class TalentInfoDAOImpl extends GenericHibernateDAO<TalentInfo, Long> implements ITalentInfoDAO {

	protected IQueryParameterParser buildQueryParameterParser() {
		return new TalentInfoQueryParameterParser();
	}

}

class TalentInfoQueryParameterParser implements IQueryParameterParser {
